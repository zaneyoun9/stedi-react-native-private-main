...
const Done = ({ ...props }) => {
  return (
    <TouchableOpacity style={{ margin: 15 }} {...props}>
      <Text>Done</Text>
    </TouchableOpacity>
  );
};
      ...
      pages={[
        {
          ...
          subtitle: (
            <View>
              ...
              >
                We value your privacy. Please share your phone number so we can
                track your balance.
              </Text>
            </View>
          ),
        ...
        },
        {
          ...
          title: (
            ...
            >
              Share STEDI Balance with you friends
            </Text>
          ),
          subtitle:
            "Share and invite your family and friends your progress with us",
        },
      ]}
    />
  );
